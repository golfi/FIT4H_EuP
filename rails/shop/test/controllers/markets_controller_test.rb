...
class MarketsControllerTest < ActionController::TestCase
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post :create, market: { description: @market.description, market_id: @market.market_id, name: @market.name }
    end
  ...
  test "should update market" do
    patch :update, id: @market, market: { description: @market.description, market_id: @market.market_id, name: @market.name }
    assert_redirected_to market_path(assigns(:market))
  end
